...
function Group() {
  ...
  const [updateGroup, isLoadingGroupName] = useAsyncMutationHook(
    useRenameGroupMutation
  );

  const [removeMember, isLoadingRemoveMember] = useAsyncMutationHook(
    useRemoveGroupMemberMutation
  );

  const [deleteGroup, isLoadingDeleteGroup] = useAsyncMutationHook(
    useDeleteGroupMutation
  );
  ...
  const ButtonGroup = (
    ...
    >
      ...
      <Button variant="contained" onClick={openAddMember}>
        Add Member
      </Button>
    </Stack>
  );
